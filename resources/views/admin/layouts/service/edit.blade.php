            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    @foreach($services as $service)
                        ...
                        <form action="{{route('adminService.update',$service->id)}}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="provider_type">
                                                <option selected
                                                        value="{{$service->provider_type}}">Selected : {{ucfirst($service->provider_type)}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                ...
                                                <option selected value="{{$service->cat_id}}">Selected : {{$service->category->cat_name}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                ...
                                                <option selected value="{{$service->city->d_id}}">Selected : {{$service->city->district->d_name}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                    ...
                                                    id="city">
                                                <option selected value="{{$service->c_id}}">Selected : {{$service->city->c_name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" id="exampleFormControlInput1"
                                                   autocomplete="off" name="phone" value="{{$service->phone}}">
                                        </div>
                                    </div>
                                    {{--                        <div class="col-md-6">--}}
                                    {{--                            <div class="form-group">--}}
                            ...
                            <div class="modal-footer">
                                <a href="{{route('adminService.index')}}"  class="btn btn-danger">Cancel</a>
